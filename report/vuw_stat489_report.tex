...
TODO, explain two group experiments, one based on OSM simulation, another based on Normal dist simulation.
  ...
  \begin{minipage}{\textwidth}
    ...
    \begin{tabular}{c|c|c|c|c|c|c}
      ...
      \textbf{Prediction} & \textbf{1} & 749 & 0 & 0 & 0 & 0 \\
                          ...
                          & \textbf{5} & 0 & 0 & 0 & 0 & 721 \\
    \end{tabular}
    \caption{5 Clusters Prediction with Normal Distribution simulation}
